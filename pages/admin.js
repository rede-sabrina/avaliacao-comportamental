...
export function QuestionModal({ open, data, onClose, onSave }){
  ...
  const flagsList = [
    ...
    { value: 'conflito_interesse', label: 'conflito_interesse — Conflito de interesse' },
    { value: 'adaptacao_risco', label: 'adaptacao_risco — Dificuldade de adaptação' },
    { value: 'relativizacao_limites', label: 'relativizacao_limites — Relativização de limites' },
    { value: 'falsificacao_informacao', label: 'falsificacao_informacao — Falsificação/omissão de informação' },
    { value: 'omissao_report', label: 'omissao_report — Omissão de reporte' },
    { value: 'pressao_companhia', label: 'pressao_companhia — Influência do grupo' },
    { value: 'risco_conformidade', label: 'risco_conformidade — Risco à conformidade' },
    ...
    { value: 'proatividade_baixa', label: 'proatividade_baixa — Baixa proatividade' },
    { value: 'autonomia_baixa', label: 'autonomia_baixa — Autonomia reduzida' },
    { value: 'comprometimento_baixo', label: 'comprometimento_baixo — Baixo comprometimento' },
    { value: 'colaboracao_fraca', label: 'colaboracao_fraca — Colaboração fraca' },
