...
export async function submitBehaviorStyleTest(data) {
  ...
  console.log('submitBehaviorStyleTest called with:', { candidateId, candidateName, candidateCpf, answersLength: answers?.length });
  ...
  try {
    ...
    console.log('dropIndex error (ignorable):', e.message);
  }
