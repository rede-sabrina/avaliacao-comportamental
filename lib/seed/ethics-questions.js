...
export const ethicsQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: 'Não falo — depois dou um jeito de resolver.', score: 0, flag: 'integridade_risco' }
    ]
  },
  ...
  },
  {
    ...
    options: [
      ...
      { letter: 'D', text: 'Começo a fazer o mesmo — se ele faz e ninguém fala, por que eu não posso?', score: 0, flag: 'integridade_risco' }
    ]
  },
  {
    test_type: 'etica',
  ...
  // ── RESPONSABILIDADE (3)
  {
    ...
    options: [
      ...
      { letter: 'C', text: 'Chego e explico o motivo quando perguntado.', score: 1, flag: 'historico_curto' },
  ...
  // ── RISCO ÉTICO (3) — score invertido (0=bom, 4=risco)
  {
    ...
    options: [
      ...
      { letter: 'C', text: 'Penso nisso como algo temporário — devolveria assim que conseguisse.', score: 1, flag: 'integridade_risco' },
